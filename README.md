...
5. **Configure o banco de dados:**
    ...
    ##ATENÇÃO SE VOCE SOFRER COM PROBLEMAS DE MIGRAÇÃO, APAGUE OS ARQUIVOS DE MIGRATION COM EXCESSAO DO __INIT__,  COMENTE TODO OS ARQUIVOS PRO PROJETO QUE INTERAJAM COM O MODELS E RODE O PYTHON MANAGE.PY MAKEMIGRATION E O MIGRATE.
